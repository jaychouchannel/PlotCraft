...
origins = _settings.cors_origins.split(",") if _settings.cors_origins else ["*"]
app.add_middleware(
    CORSMiddleware,
...
app.add_exception_handler(generate.ClientDisconnected, lambda req, exc: JSONResponse(status_code=499, content={"detail": "client disconnected"}))
